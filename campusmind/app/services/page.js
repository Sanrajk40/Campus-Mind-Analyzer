          ...
          >
            ...
            <div className="mt-8">
              <button
                ...
                className={`w-full font-semibold py-2 px-4 rounded-md shadow-sm text-sm text-center transition-all duration-300 ${theme.buttonBg} ${theme.buttonText} ${theme.buttonHover}`}
              >
                {service.actionText}
              </button>
            </div>
